   ...
   <div class="row about-wrap">
      <div class="col-full">
         ...
         <div class="intro">
            ...
            <p class="lead animate-this"><span>Hallowdawn LARP</span> is ... </p>
            <h3 class="animate-this">What is LARP</h3>
            <p class="follow-up animate-this">LARP is ... Blah blah blah blah.  </p>
         </div>
      </div>
      <!-- end col-full  -->
   </div>
      ...
      <div class="services-list block-1-2 block-tab-full group">
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               ...
               <p>Join us every Sunday from 1PM to 4PM at Henry W. Seale Park to LARP.
               </p>
         ...
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               ...
               <p>Lorem ipsum Elit ut  Duis qui culpa voluptate enim ea aute qui veniam in irure et nisi nostrud deserunt est officia minim.
      ...
      <div class="services-list block-1-2 block-tab-full group">
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               ...
               <p>Sunday LARP takes place almost every <strong>Sunday</strong> from <strong>1PM to 4PM</strong>. Check the <a class="smoothscroll blacklink" href="#calander-section">calender</a> to see all upcoming events.
               </p>
            </div>
         </div>
         <!-- end bgrid -->
...
<section id="summercamps">
   ...
   <div class="row narrow section-intro with-bottom-sep animate-this">
      <div class="col-full">
         <h1>Summer Camps</h1>
         <p class="lead">Lorem ipsum Elit ut consequat veniam eu nulla nulla reprehenderit reprehenderit sit velit in cupidatat ex aliquip ut cupidatat Excepteur tempor id irure sed dolore sint sunt voluptate ullamco nulla qui Duis qui culpa voluptate enim ea aute qui veniam in irure et nisi nostrud deserunt est officia minim. (Other things to add: Dayly schedule, what to bring)</p>
      </div>
      <!-- end col-full -->
   </div>
   <!-- end row -->
   <div class="row services-content animate-this">
      <div class="services-list block-1-2 block-tab-full group">
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               <h3 class="h05">When</h3>
               <p>The summer camp takes place in the week of <strong>June 10th to June 14th</strong>, and the week of <strong>June 24th to June 28th</strong>.
         ...
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               <h3 class="h05">Price</h3>
               <p>The admission for the camp is <strong>$400 per week</strong>, with a <strong>$50 discount for siblings and for those who sign up for both days</strong>. You may pay us on paypal, through a check, or with cash directly to any of the GMs.
               </p>
            </div>
         </div>
         <!-- end bgrid -->
      ...
      <div class="services-list block-1-2 block-tab-full group">
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               ...
               <a target="_blank" class="button button-primary full-width" href="https://drive.google.com/open?id=1JUxB8b0tZERrEWMeLlnn4-scall0YyTe">View the Rulebook</a>
            </div>
         </div>
         <!-- end bgrid -->
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               ...
               <a target="_blank" class="button button-primary full-width" href="https://discord.gg/sqjTRGb">Join the Discord Server</a>
            </div>
         </div>
         <!-- end bgrid -->
         <div class="bgrid service-item animate-this">
         ...
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               ...
               <a target="_blank" class="button button-primary full-width" href="#">Pay with Paypal</a>
            </div>
         </div>
         <!-- end bgrid -->
         <div class="bgrid service-item animate-this">
         ...
         <ul class="slides">
            <li>
               <div class="testimonial-author">
                  <img src="images/user-icon.png" alt="Author image">
...
<section id="contact">
   ...
   <div class="row narrow section-intro with-bottom-sep">
      <div class="col-twelve">
         ...
         <h1>Get In Touch.</h1>
         <p class="lead">
            [Insert intro sentence here]. If you want to ask us any questions, you can email <strong>zevgoldhabergordon@gmail.com</strong> or use the forum below. If you want to get emails about upcoming LARP sessions, put your email address in the forum below. If you want to join our discord server and talk directly with us, <a class="blacklink" href="https://discord.gg/sqjTRGb" target="_blank">click here</a>.
      </div>
   </div>
   <!-- end section-intro -->
