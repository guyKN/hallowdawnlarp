   ...
   <div class="row services-content animate-this">
      <div class="services-list block-1-2 block-tab-full group">
         ...
         <div class="bgrid service-item animate-this">
            ...
            <a target="_blank" class="button button-primary full-width" href="nopaypal.html">Pay with Paypal</a>
   ...
   <div class="row services-content animate-this">
      <div class="services-list block-1-2 block-tab-full group">
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               <h3 class="h05">When</h3>
               <p>The summer camp takes place in the week of <strong>June 10th to June 14th</strong>, and the week of <strong>June 24th to June 28th</strong>. You can come for both weeks, or just for one week. 
         ...
         <div class="bgrid service-item animate-this">
            ...
            <div class="service-content">
               <h3 class="h05">Price</h3>
               <p>The admission for the camp is <strong>$400 per week</strong>, with a <strong>$50 discount for siblings and for those who sign up for both weeks</strong>. You may pay us on paypal, through a check, or with cash directly to any of the GMs.
               </p>
            </div>
         </div>
         <!-- end bgrid -->
